...
$timestamp = $Fecha_Servidor->getTimestamp() * 1000;
...
$SQL="UPDATE $NOTES_TABLE_NAME SET $NOTE_TITLE = '$titulo_bd', $NOTE_CONTENT = '$contenido_bd', $NOTE_MODIFICATION_DATE = $timestamp, $NOTE_PENDING_CHANGES = 1 WHERE $NOTE_ID = $id_nota AND $NOTES_USER_ID = $id_usuario";
if ($conn->query($SQL)){
