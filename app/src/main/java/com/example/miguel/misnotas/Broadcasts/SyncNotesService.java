 ...
 */
public class SyncNotesService extends BroadcastReceiver implements Volley_Singleton.NotesResponseListener {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Volley_Singleton.getInstance(context).syncDBLocal_Remota(notSyncedNotes, syncedNotes, ShPrSync.getInt("userID", 1), ShPrSync.getInt("UltimoIDSync", 0), false, this);
    }
